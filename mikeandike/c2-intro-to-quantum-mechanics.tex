...
\paragraph{\cite{mikeandike} Exercise 2.15:} Show that $(A^\dagger)^\dagger =
A$.

\paragraph{Solution:} Conisider $(\ket{v}, (A^\dagger)^\dagger\ket{w})$ for all
vectors $\ket{v}, \ket{w} \in V$. Using the definition in \eqref{eq:adj},
...
\paragraph{\cite{mikeandike} Exercise 2.2:} Prove that two eigenvectors of a
